...
//   const [coverPreview, setCoverPreview] = useState(
//     userProfile?.cover_avatar ?? "/pexels-pixabay-209831.jpg"
//   );
...
//       // Only append fields if they changed
//       if (profile.bio !== userProfile?.bio) form.append("bio", profile.bio);
//       if (profile.organization !== userProfile?.organization)
//         form.append("organization", profile.organization);
...
//       // Only update changed fields in context
//       setUserProfile?.((prev) => {
//         if (!prev) return prev;
//         return {
//           ...prev,
...
//                 src={coverPreview}
//                 alt="profile"
//                 className="rounded-b-3xl rounded-t-2xl mx-auto w-full md:h-[230px] object-cover"
//               />
...
//                           unoptimized
//                         />
//                         <label className="flex items-center space-x-1.5 sm:space-x-2 text-xs sm:text-sm font-bold bg-white/20 backdrop-blur-md px-3 py-2 sm:px-5 sm:py-3 rounded-xl sm:rounded-2xl hover:bg-white/30 cursor-pointer shadow-lg">
//                           <Camera className="w-4 h-4 sm:w-5 sm:h-5" />
//                           <span>Change</span>
//                           <input
//                             type="file"
...
//               {/* Display sections like Followers, Location, Organization, Bio stay unchanged */}
//             </div>
//           </div>
//         </div>
//       </div>
