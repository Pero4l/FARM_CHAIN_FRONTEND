  ...
  return (
    <div>
      <div className="space-y-8">
        ...
        {/* hheader */}
        <div className={`${theme === 'dark' ? " bg-gradient-to-br from-white/10 to-white/15 text-white border-1" : "bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600"} rounded-3xl shadow-2xl text-white md:p-8 p-5 px-8 relative overflow-hidden`}>
