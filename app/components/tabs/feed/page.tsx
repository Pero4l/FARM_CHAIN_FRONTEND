                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap justify-between items-center mt-4 gap-2 sm:gap-4">
                        ...
                        <button className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-27 md:px-60 sm:px-8 py-2.5 rounded-xl font-bold hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-2 text-sm sm:text-base whitespace-nowrap">
